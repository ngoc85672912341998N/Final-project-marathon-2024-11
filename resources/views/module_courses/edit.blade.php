...
@section('content')
    ...
    <div class="card text-bg-theme">
         ...
         <div class="card-header d-flex justify-content-between align-items-center p-3">
            <h4 class="m-0">{{ !empty($title) ? $title : 'Module Courses' }}</h4>
            <div>
        ...
        <div class="card-body">
            ...
            <form method="POST" class="needs-validation" novalidate action="{{ route('module_courses.module_courses.update', $moduleCourses->id) }}" id="edit_module_courses_form" name="edit_module_courses_form" accept-charset="UTF-8" >
            {{ csrf_field() }}
